        ...
        <div class="product-details-slider-wrapper">
            <div class="product-bottom-slider owl-theme owl-carousel" id="sync2">
                <div class="slide-bottom-item">
                    <div class="slide-inner">
                        <img src="{{asset('auction/assets/images/product/01.png')}}" alt="product">
                    </div>
                </div>
                <div class="slide-bottom-item">
                    <div class="slide-inner">
                        <img src="{{asset('auction/assets/images/product/02.png')}}" alt="product">
                    </div>
                </div>
                <div class="slide-bottom-item">
                    <div class="slide-inner">
                        <img src="{{asset('auction/assets/images/product/03.png')}}" alt="product">
                    </div>
                </div>
                <div class="slide-bottom-item">
                    <div class="slide-inner">
                        <img src="{{asset('auction/assets/images/product/04.png')}}" alt="product">
                    </div>
                </div>
                <div class="slide-bottom-item">
                    <div class="slide-inner">
                        <img src="{{asset('auction/assets/images/product/05.png')}}" alt="product">
                    </div>
                </div>
                <div class="slide-bottom-item">
                    <div class="slide-inner">
                        <img src="{{asset('auction/assets/images/product/06.png')}}" alt="product">
                    </div>
                </div>
            </div>
            ...
            <ul class="product-tab-menu nav nav-tabs">
                <li>
                    <a href="#details" class="active" data-toggle="tab">
                        <div class="thumb">
                            <img src="{{asset('auction/assets/images/product/tab1.png')}}" alt="product">
                        </div>
                ...
                <li>
                    <a href="#delevery" data-toggle="tab">
                        <div class="thumb">
                            <img src="{{asset('auction/assets/images/product/tab2.png')}}" alt="product">
                        </div>
                ...
                <li>
                    <a href="#history" data-toggle="tab">
                        <div class="thumb">
                            <img src="{{asset('auction/assets/images/product/tab3.png')}}" alt="product">
                        </div>
                ...
                <li>
                    <a href="#questions" data-toggle="tab">
                        <div class="thumb">
                            <img src="{{asset('auction/assets/images/product/tab4.png')}}" alt="product">
                        </div>
