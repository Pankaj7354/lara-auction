                ...
                <div class="dashboard-widget mb-30 mb-lg-0">
                    <div class="user">
                        <div class="thumb-area">
                            <div class="thumb">
                                <img src="{{asset('auction/assets/images/dashboard/user.png')}}" alt="user">
                            </div>
                        ...
                        <div class="content">
                            ...
                            <span class="username"><a href="https://pixner.net/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="c0aaafa8ae80a7ada1a9aceea3afad">[email&#160;protected]</a></span>
                        </div>
                    </div>
                    ...
                    <div class="row justify-content-center mb-30-none">
                        <div class="col-md-4 col-sm-6">
                            <div class="dashboard-item">
                                <div class="thumb">
                                    <img src="{{asset('auction/assets/images/dashboard/01.png')}}" alt="dashboard">
                                </div>
                                <div class="content">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="dashboard-item">
                                <div class="thumb">
                                    <img src="{{asset('auction/assets/images/dashboard/02.png')}}" alt="dashboard">
                                </div>
                                <div class="content">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="dashboard-item">
                                <div class="thumb">
                                    <img src="{{asset('auction/assets/images/dashboard/03.png')}}" alt="dashboard">
                                </div>
                                <div class="content">
